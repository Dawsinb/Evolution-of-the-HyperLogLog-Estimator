...
def estimate(hashes, k):
  ...
  #since we want to be using more buckets anyways, and the precise value of the bias is costly to calculate. We will use this as an estimate of the bias
